...
my $nuc_alignmnent = ""; #Nucleotide alignment
...
my $reference_file = "reference_transcription_factors_mrna.fa"; #if augustus option is on, enter reference file name here.
